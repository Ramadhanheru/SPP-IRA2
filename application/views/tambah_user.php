<!-- Begin Page Content -->
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <!-- kontent -->
          <h1 class="h3 mb-4 text-gray-800">Halaman Tambah Data</h1>
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-dark">Tambah Data Admin/Jurtel</h6>
            </div>
            <div class="card-body">
              <div class="table-responsive">

                <form action="<?= base_url('welcome/tambah_user'); ?>" method="POST" enctype="multipart/form-data">
                  <div class="form-group">
                    <label for="nama_admin">Nama Lengkap</label>
                    <input type="text" class="form-control" id="nama_admin" name="nama" required>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="username_admin" name="username">
                  ...
                  <button type="submit" class="btn text-white merah" name="submit">Tambah Data</button>
                </form>
